...
impl BlockWithTxs {
    pub fn new(block_hash: BlockHash, block: Block, finality_status: FinalityStatus) -> Self {
        let l1_gas_price = ResourcePrice {
            price_in_wei: block.header.gas_prices.eth_l1_gas_price.into(),
            price_in_fri: block.header.gas_prices.fri_l1_gas_price.into(),
        };
...
impl PendingBlockWithTxs {
    pub fn new(header: PartialHeader, transactions: Vec<TxWithHash>) -> Self {
        ...
        let l1_gas_price = ResourcePrice {
            price_in_wei: header.gas_prices.eth_l1_gas_price.into(),
            price_in_fri: header.gas_prices.fri_l1_gas_price.into(),
        };
