...
lazy_static! {
    ...
    pub static ref SEQUENCER_ADDRESS: ContractAddress = ContractAddress(felt!("0x69420"));
    ...
    pub static ref DEFAULT_ACCOUNT_CONTRACT_CLASS_HASH: FieldElement = felt!("0x04d07e40e93398ed3c76981e72dd1fd22557a78ce36c0515f679e27f0bb5bc5f");
    ...
    pub static ref DEFAULT_ACCOUNT_CONTRACT: CompiledContractClass = parse_legacy_contract_class(include_str!("../contracts/compiled/account.json"));
