...
use katana_primitives::transaction::{
    DeclareTx, DeclareTxV2, DeclareTxWithClass, DeployAccountTx, ExecutableTx,
    ExecutableTxWithHash, InvokeTx,
};
...
pub fn valid_blocks() -> [ExecutableBlock; 3] {
    ...
    let gas_prices = GasPrices { eth: 100 * u64::pow(10, 9), strk: 100 * u64::pow(10, 9) };
    ...
    [
        ExecutableBlock {
            ...
            body: vec![
                ...
                ExecutableTxWithHash::new(ExecutableTx::Invoke(InvokeTx {
                    chain_id,
                    sender_address,
                    calldata: vec![
                        felt!("0x1"),
        ...
        ExecutableBlock {
            ...
            body: vec![
                ...
                ExecutableTxWithHash::new(ExecutableTx::DeployAccount(DeployAccountTx {
                    chain_id,
