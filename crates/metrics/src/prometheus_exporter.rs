...
fn collect_memory_stats() {
    ...
    {
        let gauge = gauge!("jemalloc.active");
    ...
    {
        let gauge = gauge!("jemalloc.allocated");
        gauge.set(value as f64);
    }
    ...
    {
        let gauge = gauge!("jemalloc.mapped");
        gauge.set(value as f64);
    }
    ...
    {
        let gauge = gauge!("jemalloc.metadata");
        gauge.set(value as f64);
    }
    ...
    {
        let gauge = gauge!("jemalloc.resident");
        gauge.set(value as f64);
    }
    ...
    {
        let gauge = gauge!("jemalloc.retained");
        gauge.set(value as f64);
    }
}
