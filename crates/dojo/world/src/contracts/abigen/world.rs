...
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            16usize => Ok(Event::StoreDelRecord(StoreDelRecord::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            17usize => Ok(Event::WriterUpdated(WriterUpdated::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            18usize => Ok(Event::OwnerUpdated(OwnerUpdated::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            _ => {
