...
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            14usize => Ok(Event::StoreUpdateRecord(StoreUpdateRecord::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            15usize => Ok(Event::StoreUpdateMember(StoreUpdateMember::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            16usize => {
...
impl<A: starknet::accounts::ConnectedAccount + Sync> WorldContract<A> {
    ...
    pub fn get_number_of_owners(
        ...
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
            entry_point_selector: starknet::macros::selector!("get_number_of_owners"),
            calldata: __calldata,
        };
        cainome::cairo_serde::call::FCall::new(__call, self.provider())
    }
