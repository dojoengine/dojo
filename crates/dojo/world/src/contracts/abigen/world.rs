...
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            10usize => Ok(Event::LibraryRegistered(
                LibraryRegistered::cairo_deserialize(__felts, __offset + 1)?,
            )),
            11usize => Ok(Event::EventEmitted(EventEmitted::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            12usize => Ok(Event::MetadataUpdate(MetadataUpdate::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            13usize => Ok(Event::StoreSetRecord(StoreSetRecord::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            14usize => Ok(Event::StoreUpdateRecord(
                StoreUpdateRecord::cairo_deserialize(__felts, __offset + 1)?,
            )),
            15usize => Ok(Event::StoreUpdateMember(
                StoreUpdateMember::cairo_deserialize(__felts, __offset + 1)?,
            )),
            16usize => Ok(Event::StoreUpdateMembers(
                StoreUpdateMembers::cairo_deserialize(__felts, __offset + 1)?,
            )),
            17usize => Ok(Event::StoreDelRecord(StoreDelRecord::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            18usize => Ok(Event::WriterUpdated(WriterUpdated::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            19usize => Ok(Event::OwnerUpdated(OwnerUpdated::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            _ => {
