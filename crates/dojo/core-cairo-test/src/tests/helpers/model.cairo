...
pub fn deploy_world_for_model_upgrades() -> IWorldDispatcher {
    let namespace_def = NamespaceDef {
        namespace: "dojo",
        resources: [
            TestResource::Model(m_OldFooModelBadLayoutType::TEST_CLASS_HASH.try_into().unwrap()),
            TestResource::Model(m_OldFooModelMemberRemoved::TEST_CLASS_HASH.try_into().unwrap()),
            TestResource::Model(
                m_OldFooModelMemberAddedButRemoved::TEST_CLASS_HASH.try_into().unwrap(),
            ),
            TestResource::Model(
                m_OldFooModelMemberAddedButMoved::TEST_CLASS_HASH.try_into().unwrap(),
            ),
            TestResource::Model(m_OldFooModelMemberAdded::TEST_CLASS_HASH.try_into().unwrap()),
            TestResource::Model(m_OldFooModelMemberChanged::TEST_CLASS_HASH.try_into().unwrap()),
            TestResource::Model(
                m_OldFooModelMemberIllegalChange::TEST_CLASS_HASH.try_into().unwrap(),
            ),
            TestResource::Model(m_OldModelWithNestedEnumKey::TEST_CLASS_HASH.try_into().unwrap()),
        ]
            .span(),
    };
