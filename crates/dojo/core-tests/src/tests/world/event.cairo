...
#[test]
#[should_panic(
    expected: "Account `0xa11ce` does NOT have OWNER role on event (or its namespace) `FooEventMemberAdded`",
)]
...
#[test]
#[should_panic(
    expected: "Contract `0x689182009041e32f4fe01e177f1f2664b1a198ce0e76263fdf13c2bc1fb7a56` does NOT have OWNER role on namespace `dojo`",
)]
