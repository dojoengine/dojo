...
#[should_panic(
    expected: "Contract `0x3caede587f5fbecec85d4fedc6aa8c5d1f9c1b7e105dc70f8ee5e2e010a03ff` does NOT have OWNER role on contract (or its namespace) `test_contract`",
)]
