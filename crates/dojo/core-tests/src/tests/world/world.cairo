...
#[available_gas(l2_gas: 6000000)]
#[should_panic(
    expected: "Contract `0x201c993df8aa75893465bccb26b59ff8f288acccf8ce17d8400e7bff423b13c` does NOT have OWNER role on contract (or its namespace) `test_contract`",
)]
