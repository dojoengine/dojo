...
abigen!(
  ...
  {
    "type": "struct",
    "name": "dojo::model::model::ModelDefinition",
    "members": [
      {
        "name": "selector",
        "type": "core::felt252"
  ...
  {
    "type": "struct",
    "name": "dojo::model::model::ModelInfo",
    "members": [
      {
        "name": "namespace",
        "type": "core::byte_array::ByteArray"
  ...
  {
    "type": "enum",
    "name": "dojo::world::world_contract::ResourceType",
    "variants": [
      {
        "name": "Model",
        "type": "()"
  ...
  {
    "type": "struct",
    "name": "dojo::contract::contract::ContractDefinition",
    "members": [
      {
        "name": "class_hash",
  ...
  },
  {
    ...
    "variants": [
      {
        "name": "Model",
        "type": "dojo::model::model::ModelDefinition"
      },
      {
        "name": "Contract",
        "type": "dojo::contract::contract::ContractDefinition"
      },
      {
        "name": "Namespace",
        "type": "()"
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "outputs": [
          {
            "type": "dojo::model::model::ModelInfo"
          }
        ],
        "state_mutability": "view"
      },
      ...
      },
      {
        ...
        "outputs": [
          {
            "type": "dojo::world::world_contract::ResourceType"
          }
        ],
        "state_mutability": "view"
      },
