...
use crate::constants::{
    DATETIME_FORMAT, ENTITY_TABLE, ERC20_BALANCE_NAMES, ERC20_BALANCE_TYPE_NAME, EVENT_ID_COLUMN,
    ID_COLUMN,
};
...
impl BasicObject for Erc20Balance {
...
impl ResolvableObject for Erc20Balance {
