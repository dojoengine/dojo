...
fn test_admin_system_but_non_admin_caller() {
    ...
    let role = world.entity('AuthRole', QueryTrait::new_from_id(caller.into()), 0, 0);
...
fn test_set_entity_directly() {
    ...
    data.append(420);
    data.append(1337);
    world.set_entity(ctx, 'Foo', QueryTrait::new_from_id(id.into()), 0, data.span());
}
...
fn test_grant_role() {
    ...
    let role = world.entity('AuthRole', 'Bar', 0, 0);
