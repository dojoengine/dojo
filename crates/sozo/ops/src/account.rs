...
pub async fn new(signer: LocalWallet, force: bool, file: PathBuf) -> Result<FieldElement> {
...
pub async fn deploy(
    ...
    assert_eq!(account_deployment.address(), target_deployment_address, "Unexpected account deployment address mismatch");
