...
async fn test_model_ops() {
    ...
    assert_eq!(
        ...
        .await
        .unwrap(),
        Felt::from_hex("0xbce546ee27713cb53d0ab70d08da90dabccba1de7deeee14bec49dd7d6e7f").unwrap()
    );
    ...
    assert_eq!(
        ...
        .await
        .unwrap(),
        Felt::from_hex("0x759ae2622a4b77066269a624efa5f7f0d4343c5e83b1c4591d02f5f53a51417")
            .unwrap()
    );
