...
async fn test_model_ops() {
    ...
    assert_eq!(
        ...
        .await
        .unwrap(),
        Felt::from_hex("0x28d469fa541e5343e13c53ed79c40c423060c29b01994cf651c585051ab18a3")
            .unwrap()
    );
    ...
    assert_eq!(
        ...
        .await
        .unwrap(),
        Felt::from_hex("0x3269ace72d7fab605167b2829e53c35963fde4006560fee39586457cd5640b5")
            .unwrap()
    );
