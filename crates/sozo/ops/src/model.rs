    ...
    P: Provider + Send + Sync,
{
    ...
    world_reader.set_block(BlockId::Tag(BlockTag::Latest));
    ...
    P: Provider + Send + Sync,
{
    ...
    let use_legacy_storage = model.use_legacy_storage().await?;
...
fn format_array(
    ...
    format_fixed_array(item, length, use_legacy_storage, values, level, start_indent)
}

fn format_fixed_array(
    item: &Ty,
    length: u32,
    use_legacy_storage: bool,
    values: &mut Vec<Felt>,
