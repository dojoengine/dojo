...
impl Entity {
    ...
    pub async fn state_updates(&self, context: &Context) -> FieldResult<Vec<entity_state_update::EntityStateUpdate>> {
        entity_state_update::entity_state_updates_by_entity(context, self.id.clone()).await
    }
    
    pub async fn states(&self, context: &Context) -> FieldResult<Vec<entity_state_update::EntityStateUpdate>> {
        entity_state_update::entity_state_updates_by_entity(context, self.id.clone()).await
    }
}
