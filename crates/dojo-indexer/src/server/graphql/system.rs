...
use super::{component::Component, system_call::SystemCall, Query, entity_state_update::EntityStateUpdate, entity_state::EntityState, entity::Entity};
    ...
    async fn system(context: &PrismaClient, id: String) -> Option<System> {
        ...
        match system {
            Some(system) => Some(System {
                ...
                calls: system.calls.unwrap().into_iter().map(|call| SystemCall {
                    id: call.id,
                    data: call.data,
                ...
                query_components: system
                    ...
                    .map(|component| Component {
                        ...
                        systems: vec![],
                        states: component.states.unwrap().into_iter().map(|state| {
                            EntityState {
                                data: state.data,
                                component: Component {
                        ...
                        state_updates: component.state_updates.unwrap().into_iter().map(|state_update| {
                            EntityStateUpdate {
                                id: state_update.id,
